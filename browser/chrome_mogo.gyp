  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        '<(DEPTH)/c4a/browser/cookie_manager.cc',
        '<(DEPTH)/c4a/browser/cookie_manager.h',
        ...
        '<(DEPTH)/c4a/browser/url_util.cc',
        '<(DEPTH)/c4a/browser/url_util.h',
    ...
    },
    {
      ...
      'sources': [
        ...
        'java/src/com/mogoweb/browser/utils/URLUtil.java',
        'java/src/com/mogoweb/browser/web/CookieManager.java',
